...
namespace StbSharp
{
    public readonly struct ZlibHeader
    {
        ...
        public static FLevel ConvertLevel(CompressionLevel level)
        {
            switch (level)
            {
                case CompressionLevel.NoCompression: return FLevel.Faster;
                case CompressionLevel.Fastest: return FLevel.Default;
                case CompressionLevel.Optimal: return FLevel.Optimal;
        ...
        public static CompressionLevel ConvertLevel(FLevel level)
        {
            switch (level)
            {
                case FLevel.Faster: return CompressionLevel.NoCompression;
                case FLevel.Default: return CompressionLevel.Fastest;
                case FLevel.Optimal: return CompressionLevel.Optimal;
